...
Rvv0 = PREAMBLE_QPSK_IFFT*PREAMBLE_QPSK_IFFT'/(PREAMBLE_LEN);
MAX_STEP_SIZE = 1/(CHAN_LEN*Rvv0); % MAXIMUM STEP SIZE
...
INPUT = fliplr(PREAMBLE_QPSK_IFFT(i1:i1+CHAN_LEN-1));
